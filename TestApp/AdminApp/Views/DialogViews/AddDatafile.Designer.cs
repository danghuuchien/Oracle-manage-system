namespace AdminApp.Views.DialogViews
{
	partial class AddDatafile
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Add new datafile to tablespace";
			// 
			// comboBox1
			// 
			...
			this.label5.Text = "Autoextended Size";
			// 
			// label6
			// 
			...
			this.textBox4.Location = new System.Drawing.Point(156, 286);
			...
			this.button1.Location = new System.Drawing.Point(243, 394);
			...
			this.Text = "AddDatafile";
			this.Load += new System.EventHandler(this.AddDatafile_Load);
